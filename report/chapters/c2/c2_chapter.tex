...
\subsection{Tổng quan về mã độc}
...
\subsection{Tổng quan về định dạng PE trên Windows}
...
\subsection{Trích xuất đặc trưng từ PE}
...
\subsubsection{Đặc trưng tổng quát của PE}

Nhóm đặc trưng này phản ánh các thông tin tổng quát của PE, bao
...
Light Gradient Boosting Machine (LightGBM) \cite{lgbm} là một mô hình học máy
...
\subsection{Các nghiên cứu về trích xuất năng lực của file thực thi nhị phân}
...
\subsection{Các nghiên cứu về lý giải quyết định của mô hình}
