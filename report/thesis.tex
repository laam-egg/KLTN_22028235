...
%
\title{Ứng dụng học máy trong phát hiện mã độc PE trên Windows}	%% title
\author{Vũ Tùng Lâm}			%% author's name
...
% Source - https://tex.stackexchange.com/a/89576
% Posted by commonhare, modified by community. See post 'Timeline' for change history
