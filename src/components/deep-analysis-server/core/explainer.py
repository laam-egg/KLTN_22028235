...
import json
with open(SCRIPT_DIR / "capa" / "capa_features.json", 'r', encoding='utf-8') as f:
...
MODELS_PATH = Path(SCRIPT_DIR / "models")
...
def explain(file_path: str) -> str:
    ...
    def export_html(json_content: str) -> str:
        ...
        template_file_path = SCRIPT_DIR / 'explanation.html.template'
